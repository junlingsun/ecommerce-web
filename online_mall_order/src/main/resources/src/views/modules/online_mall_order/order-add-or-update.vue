    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          totalAmount: [
            { required: true, message: '?????ܶ不能为空', trigger: 'blur' }
          ],
          payAmount: [
            { required: true, message: 'Ӧ???ܶ不能为空', trigger: 'blur' }
          ],
          freightAmount: [
            { required: true, message: '?˷ѽ不能为空', trigger: 'blur' }
          ],
          promotionAmount: [
          ...
          integration: [
            { required: true, message: '???Ի??õĻ不能为空', trigger: 'blur' }
          ],
          growth: [
          ...
          receiverPostCode: [
            { required: true, message: '?ջ????ʱ不能为空', trigger: 'blur' }
          ],
          receiverProvince: [
          ...
          useIntegration: [
            { required: true, message: '?µ?ʱʹ?õĻ不能为空', trigger: 'blur' }
          ],
          paymentTime: [
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/online_mall_order/order/info/${this.dataForm.id}`),
              method: 'get',
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/online_mall_order/order/${!this.dataForm.id ? 'save' : 'update'}`),
              method: 'post',
